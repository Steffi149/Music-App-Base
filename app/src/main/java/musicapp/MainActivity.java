...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        details.setOnClickListener(new OnClickListener() {
            // The code in this method will be executed when the details category is clicked on.
            @Override
            public void onClick(View view) {
        ...
        // Find the View that shows the trending category
        TextView trending = (TextView) findViewById(R.id.trending);

        // Set a click listener on that View
        trending.setOnClickListener(new OnClickListener() {
            // The code in this method will be executed when the trending category is clicked on.
            @Override
            public void onClick(View view) {
                // Create a new intent to open the {@link TrendingActivity}
